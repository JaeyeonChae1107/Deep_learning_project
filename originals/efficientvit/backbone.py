"""
Official EfficientViT backbone architecture.
Source: https://github.com/mit-han-lab/efficientvit/blob/master/efficientvit/models/efficientvit/backbone.py
License: MIT

Note: This file requires the full efficientvit package to run.
  pip install efficientvit
  or: git clone https://github.com/mit-han-lab/efficientvit
"""
